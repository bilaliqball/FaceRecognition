...
public double[][]getAdjustedFaces(){return adjFaces;}
public double[][]getEigenFaces(){return eigenFaces;}
public double[] getAvgFace(){return averageFace;}
public double[] getEigenValues(){return eigenValues;}
public List<String> getImageFileNamesList(){return imageFileNamesList;}
